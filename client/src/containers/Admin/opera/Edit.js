...
const Edit = () => {
  ...
  const fetchDataProduct = async () => {
    let _id = param?._id;
    let dataProduct = operas?.filter((items) => items?._id === _id);
    ...
    <div className="p-4 ">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4 ">
          <h1 className="text-xl font-semibold">Edit a Opera</h1>
          <button
            onClick={() => navigate(-1)}
...
Save and Continue Edit
      ...
      <div className="bg-white border-t-4 mt-3 rounded-md border-t-blue-300">
        <div className="p-2">
          <h1 className="capitalize text-lg border-b px-4 py-2 ">Opera Info</h1>
